...
declare -a tests=(
"-s test_files/test_text_grep.txt VAR"
"for grep.c grep.h Makefile VAR"
"for grep.c VAR"
"-e for -e ^int grep.c grep.h Makefile VAR"
"-e for -e ^int grep.c VAR"
"-e regex -e ^print grep.c VAR -f test_files/test_ptrn_grep.txt"
"-e while -e void grep.c Makefile VAR -f test_files/test_ptrn_grep.txt"
"VAR no_file.txt"
)
